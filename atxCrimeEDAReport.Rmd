...
[![https://www.deepsentinel.com/blogs/home-security/safest-neighborhoods-in-austin/](https://cdn-gnflf.nitrocdn.com/oLzuXrOSBZcEOcWEWWyWBqotmYtrWuwi/assets/images/optimized/rev-365f3a7/www.deepsentinel.com/wp-content/uploads/2022/10/Safest-Neighborhoods-in-Austin-Map-1024x640.jpg){width="426"}](https://www.deepsentinel.com/blogs/home-security/safest-neighborhoods-in-austin/)

-   previous study or news article; describe how it ties with project; Why is this topic important for you to investigate? What are your motivations
...
clean_Crime <- atxCrime|>
  ...
  mutate(Occurred = mdy_hm(Occurred),
         ...
         Difference = difftime(Report, Occurred, units = "hours"),
         Region = case_when(
...
-   how many rows/columns did you start/end with; reason why number of rows/columns may be different before/after wrangling

-   justify if data is tidy

### Results

-   make a visualization exploring the distribution of each variable in the research question and report summary stats

    -   Which Austin region has the most crime of any type, and which crime type is the most common in each region, including family violence? (Sophia)
